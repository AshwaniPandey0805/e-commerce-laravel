                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" value="{{ $coupon->code }}"  id="code" class="form-control" placeholder="Enter Code">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $coupon->name }}" class="form-control" placeholder="Enter Name">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_uses" id="max_uses" value="{{ $coupon->max_uses }}" class="form-control" placeholder="Max Usage">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_uses_user" value="{{ $coupon->max_uses_user }}" id="max_uses_user" class="form-control" placeholder="Max User Usage">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="discount_amount" value="{{ $coupon->discount_amount }}" id="discount_amount" class="form-control" placeholder="Enter Discount Amount">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_amount" id="min_amount" class="form-control" value="{{ $coupon->min_amount }}" placeholder="Enter Discount Amount">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" autocomplete="off" name="start_at" id="start_at" value="{{ \Carbon\Carbon::parse($coupon->start_at)->format('Y-m-d H:i:s') }}" class="form-control" placeholder="Enter Discount Amount">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" autocomplete="off" name="end_at" id="end_at" value="{{ \Carbon\Carbon::parse($coupon->end_at)->format('Y-m-d H:i:s') }}" class="form-control" placeholder="Enter Discount Amount">
                                    <p></p>	
                                </div>
                            </div>
                            <div class="col-md-6">
...
@section('customeJS')
    <script>
        ...
        $.ajax({
            url: "{{route('coupon.update',$coupon->id)}}",  // Corrected with quotes
            type: 'POST',
